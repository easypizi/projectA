  ...
  (function ($) {
    ...
    $.fn.numeric = function (config, callback) {
      ...
      return this.data("numeric.decimal", decimal)
        ...
        .data("numeric.scale", scale)
        .data("numeric.precision", precision)
      ...
      // if a number key was pressed.
        ...
        if ($.data(this, "numeric.scale") >= 0) {
          ...
          if (decimalPosition >= 0) {
            let decimalsQuantity = this.value.length - decimalPosition - 1;
            ...
            if ($.fn.getSelectionStart(this) > decimalPosition) {
              ...
              let integersQuantity = this.value.length - 1 - decimalsQuantity;
              // If precision > 0, integers and decimals quantity should not be greater than precision
              if (
                integersQuantity <
                $.data(this, "numeric.precision") -
                  $.data(this, "numeric.scale")
              ) {
                allow = true;
              } else {
                allow = false;
          ...
          // If there is no decimal
            ...
            if ($.data(this, "numeric.precision") > 0) {
              allow =
                this.value.replace($.data(this, "numeric.decimal"), "").length <
                $.data(this, "numeric.precision") -
                  $.data(this, "numeric.scale");
            } else {
              allow = true;
      ...
      if (val && val.length > 0) {
        ...
        if (firstDecimal > 0) {
          ...
          if ($.data(this, "numeric.scale") >= 0) {
            val = val.substring(
              0,
              firstDecimal + $.data(this, "numeric.scale") + 1
            );
          }
        ...
        // limite the integers quantity, necessary when user delete decimal separator
          ...
          val = val.substring(
            0,
            $.data(this, "numeric.precision") - $.data(this, "numeric.scale")
          );
        }
